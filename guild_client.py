...
1) The commands _.help_ and _.admin_ offer a short summary of all the bot's features. _.Help_ will only show those features which have been activated. There is also the guide which lists every feature the bot has: https://stamby.github.io/easy-pete-bot
