...
All features can be enabled, disabled or customized with the help of _.enable,_ _.disable_ and _.set._ Additionally, the bot can welcome users and clean up unused roles (which may be coupled with the _.iam_ command) for smooth role management.
